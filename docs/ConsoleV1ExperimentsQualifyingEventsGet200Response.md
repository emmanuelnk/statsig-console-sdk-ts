...
```typescript
import { ConsoleV1ExperimentsQualifyingEventsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ExperimentsQualifyingEventsGet200Response = {
    message,
    data,
    pagination,
};
