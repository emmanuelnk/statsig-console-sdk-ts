...
**description** | **string** | Optional detailed context for the assignment source. | [optional] [default to undefined]
...
```typescript
import { AssignmentSourceCreationDto } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: AssignmentSourceCreationDto = {
    name,
    description,
    isVerified,
    tags,
