...
```typescript
import { ConsoleV1MetricsMetricSourceNameMetricsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1MetricsMetricSourceNameMetricsGet200Response = {
    message,
    data,
    pagination,
};
