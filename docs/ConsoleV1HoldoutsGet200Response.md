...
**data** | [**Array&lt;HoldoutDto&gt;**](HoldoutDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1HoldoutsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1HoldoutsGet200Response = {
    message,
    data,
    pagination,
};
