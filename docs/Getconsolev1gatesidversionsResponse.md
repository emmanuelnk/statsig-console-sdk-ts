...
Response for getconsolev1gatesidversions
...
```typescript
import { Getconsolev1gatesidversionsResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1gatesidversionsResponse = {
    message,
    data,
    pagination,
};
