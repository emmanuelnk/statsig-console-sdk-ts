# ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInner
...
**dimensionBreakdown** | [**Array&lt;ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner&gt;**](ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInner } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInner = {
    metricID,
    metricName,
    directionality,
    absoluteChange,
