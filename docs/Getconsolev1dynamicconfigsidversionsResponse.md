...
Response for getconsolev1dynamicconfigsidversions
...
```typescript
import { Getconsolev1dynamicconfigsidversionsResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1dynamicconfigsidversionsResponse = {
    message,
    data,
    pagination,
};
