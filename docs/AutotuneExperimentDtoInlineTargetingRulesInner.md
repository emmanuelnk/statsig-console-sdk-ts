# AutotuneExperimentDtoInlineTargetingRulesInner
...
```typescript
import { AutotuneExperimentDtoInlineTargetingRulesInner } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: AutotuneExperimentDtoInlineTargetingRulesInner = {
    name,
    passPercentage,
    conditions,
    environments,
