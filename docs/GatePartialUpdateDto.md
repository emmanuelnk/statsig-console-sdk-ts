...
**rules** | [**Array&lt;AutotuneExperimentDtoInlineTargetingRulesInner&gt;**](AutotuneExperimentDtoInlineTargetingRulesInner.md) |  | [optional] [default to undefined]
...
```typescript
import { GatePartialUpdateDto } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: GatePartialUpdateDto = {
    name,
    isEnabled,
    description,
    rules,
