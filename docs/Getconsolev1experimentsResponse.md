...
Response for getconsolev1experiments
...
```typescript
import { Getconsolev1experimentsResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1experimentsResponse = {
    message,
    data,
    pagination,
};
