...
export interface ExternalGateDto {
    ...
    'status': ExternalGateDtoStatusEnum;
    'type': ExternalGateDtoTypeEnum;
...
export const ExternalGateDtoStatusEnum = {
...
export type ExternalGateDtoStatusEnum = typeof ExternalGateDtoStatusEnum[keyof typeof ExternalGateDtoStatusEnum];
export const ExternalGateDtoTypeEnum = {
    Temporary: 'TEMPORARY',
    Permanent: 'PERMANENT',
    Stale: 'STALE',
    Template: 'TEMPLATE'
...
export type ExternalGateDtoTypeEnum = typeof ExternalGateDtoTypeEnum[keyof typeof ExternalGateDtoTypeEnum];
export const ExternalGateDtoTypeReasonEnum = {
    None: 'NONE',
...
export type ExternalGateDtoTypeReasonEnum = typeof ExternalGateDtoTypeReasonEnum[keyof typeof ExternalGateDtoTypeReasonEnum];
