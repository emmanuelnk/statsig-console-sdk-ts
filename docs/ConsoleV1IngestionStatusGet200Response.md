...
**data** | [**Array&lt;IngestionStatusDto&gt;**](IngestionStatusDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1IngestionStatusGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1IngestionStatusGet200Response = {
    message,
    data,
    pagination,
};
