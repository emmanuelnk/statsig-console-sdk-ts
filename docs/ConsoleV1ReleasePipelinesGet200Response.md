...
**data** | [**Array&lt;ReleasePipelineDto&gt;**](ReleasePipelineDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1ReleasePipelinesGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ReleasePipelinesGet200Response = {
    message,
    data,
    pagination,
};
