...
**data** | [**Array&lt;LayerContractDto&gt;**](LayerContractDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1LayersGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1LayersGet200Response = {
    message,
    data,
    pagination,
};
