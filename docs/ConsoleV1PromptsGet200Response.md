...
**data** | [**Array&lt;ExternalPromptDto&gt;**](ExternalPromptDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1PromptsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1PromptsGet200Response = {
    message,
    data,
    pagination,
};
