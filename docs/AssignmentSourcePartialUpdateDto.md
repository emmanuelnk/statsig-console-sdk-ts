...
------------ | ------------- | ------------- | -------------
**name** | **string** | Unique identifier for the assignment source. | [optional] [default to undefined]
**description** | **string** | Detailed context and purpose of the assignment source. | [optional] [default to undefined]
...
**sql** | **any** | SQL query defining the data source for assignments. | [optional] [readonly] [default to undefined]
**timestampColumn** | **string** | Column name representing the timestamp of assignments. | [optional] [default to undefined]
**experimentIDColumn** | **string** | Column name for the experiment ID associated with the assignments. | [optional] [default to undefined]
**groupIDColumn** | **string** | Column name for the group ID linked to the assignments. | [optional] [default to undefined]
**groupNameColumn** | **string** | Optional column name for the group name linked to the assignments. | [optional] [default to undefined]
**idTypeMapping** | [**Array&lt;AssignmentSourceContractDtoIdTypeMappingInner&gt;**](AssignmentSourceContractDtoIdTypeMappingInner.md) | Mappings of Statsig units to their respective columns. | [optional] [default to undefined]
