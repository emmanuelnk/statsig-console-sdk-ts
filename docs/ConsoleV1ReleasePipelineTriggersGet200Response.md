...
**data** | [**Array&lt;ReleasePipelineTriggerResponseDto&gt;**](ReleasePipelineTriggerResponseDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1ReleasePipelineTriggersGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ReleasePipelineTriggersGet200Response = {
    message,
    data,
    pagination,
};
