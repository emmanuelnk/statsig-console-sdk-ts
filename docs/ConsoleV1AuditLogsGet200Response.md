# ConsoleV1AuditLogsGet200Response
...
**data** | [**Array&lt;AuditLogDto&gt;**](AuditLogDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1AuditLogsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1AuditLogsGet200Response = {
    message,
    data,
    pagination,
};
