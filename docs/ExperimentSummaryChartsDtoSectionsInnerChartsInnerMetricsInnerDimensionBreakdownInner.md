# ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner
...
**dimensionKey** | **string** |  | [default to undefined]
**dimensionType** | **string** |  | [optional] [default to undefined]
**dimensionValue** | **string** |  | [default to undefined]

## Example

```typescript
import { ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner = {
    metricID,
    metricName,
    directionality,
    absoluteChange,
