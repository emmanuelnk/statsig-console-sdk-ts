...
**data** | [**IDListDto**](IDListDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1SegmentsIdIdListGet200Response } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: ConsoleV1SegmentsIdIdListGet200Response = {
    message,
    data,
    pagination,
};
