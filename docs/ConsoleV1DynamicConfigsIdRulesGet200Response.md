...
**data** | [**Array&lt;DynamicConfigRulesDto&gt;**](DynamicConfigRulesDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1DynamicConfigsIdRulesGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1DynamicConfigsIdRulesGet200Response = {
    message,
    data,
    pagination,
};
