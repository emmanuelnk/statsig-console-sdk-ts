# DynamicConfigCreateDtoRulesInner
...
```typescript
import { DynamicConfigCreateDtoRulesInner } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: DynamicConfigCreateDtoRulesInner = {
    name,
    passPercentage,
    conditions,
    environments,
