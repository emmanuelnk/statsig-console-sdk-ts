...
**data** | [**Array&lt;SegmentDto&gt;**](SegmentDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1SegmentsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1SegmentsGet200Response = {
    message,
    data,
    pagination,
};
