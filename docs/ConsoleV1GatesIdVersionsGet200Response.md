...
**data** | [**Array&lt;ExternalGateDto&gt;**](ExternalGateDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1GatesIdVersionsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1GatesIdVersionsGet200Response = {
    message,
    data,
    pagination,
};
