# PrecommitHookArgsDtoOneOf2OldConfig
...
```typescript
import { PrecommitHookArgsDtoOneOf2OldConfig } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: PrecommitHookArgsDtoOneOf2OldConfig = {
    id,
    name,
    idType,
    description,
