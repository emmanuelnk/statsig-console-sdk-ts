...
Response for getconsolev1experimentsidversions
...
```typescript
import { Getconsolev1experimentsidversionsResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1experimentsidversionsResponse = {
    message,
    data,
    pagination,
};
