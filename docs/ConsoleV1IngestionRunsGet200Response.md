...
**data** | [**Array&lt;IngestionRunDataContractDto&gt;**](IngestionRunDataContractDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1IngestionRunsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1IngestionRunsGet200Response = {
    message,
    data,
    pagination,
};
