 ...
 */
export interface ExternalMetricDefinitionContractDtoWarehouseNative {
    /**
     * Allowed: count┃sum┃mean┃daily_participation┃ratio┃funnel┃count_distinct┃percentile
     */
    'aggregation'?: ExternalMetricDefinitionContractDtoWarehouseNativeAggregationEnum;
    /**
     ...
     * Allowed: count┃sum┃mean┃daily_participation┃ratio┃funnel┃count_distinct┃percentile
     */
    'denominatorAggregation'?: ExternalMetricDefinitionContractDtoWarehouseNativeDenominatorAggregationEnum;
    /**
     ...
     */
    'funnelCountDistinct'?: ExternalMetricDefinitionContractDtoWarehouseNativeFunnelCountDistinctEnum;
    /**
     ...
     */
    'funnelStartCriteria'?: ExternalMetricDefinitionContractDtoWarehouseNativeFunnelStartCriteriaEnum;
    /**
     ...
     */
    'numeratorAggregation'?: ExternalMetricDefinitionContractDtoWarehouseNativeNumeratorAggregationEnum;
    /**
...
export const ExternalMetricDefinitionContractDtoWarehouseNativeAggregationEnum = {
    Count: 'count',
    Sum: 'sum',
    Mean: 'mean',
...
export type ExternalMetricDefinitionContractDtoWarehouseNativeAggregationEnum = typeof ExternalMetricDefinitionContractDtoWarehouseNativeAggregationEnum[keyof typeof ExternalMetricDefinitionContractDtoWarehouseNativeAggregationEnum];
export const ExternalMetricDefinitionContractDtoWarehouseNativeDenominatorAggregationEnum = {
    Count: 'count',
    Sum: 'sum',
    Mean: 'mean',
    DailyParticipation: 'daily_participation',
...
export type ExternalMetricDefinitionContractDtoWarehouseNativeDenominatorAggregationEnum = typeof ExternalMetricDefinitionContractDtoWarehouseNativeDenominatorAggregationEnum[keyof typeof ExternalMetricDefinitionContractDtoWarehouseNativeDenominatorAggregationEnum];
export const ExternalMetricDefinitionContractDtoWarehouseNativeFunnelCountDistinctEnum = {
    Sessions: 'sessions',
    Users: 'users'
} as const;

export type ExternalMetricDefinitionContractDtoWarehouseNativeFunnelCountDistinctEnum = typeof ExternalMetricDefinitionContractDtoWarehouseNativeFunnelCountDistinctEnum[keyof typeof ExternalMetricDefinitionContractDtoWarehouseNativeFunnelCountDistinctEnum];
export const ExternalMetricDefinitionContractDtoWarehouseNativeFunnelStartCriteriaEnum = {
    StartEvent: 'start_event',
    Exposure: 'exposure'
} as const;

export type ExternalMetricDefinitionContractDtoWarehouseNativeFunnelStartCriteriaEnum = typeof ExternalMetricDefinitionContractDtoWarehouseNativeFunnelStartCriteriaEnum[keyof typeof ExternalMetricDefinitionContractDtoWarehouseNativeFunnelStartCriteriaEnum];
export const ExternalMetricDefinitionContractDtoWarehouseNativeNumeratorAggregationEnum = {
    Count: 'count',
    Sum: 'sum',
    Mean: 'mean',
    DailyParticipation: 'daily_participation',
...
export type ExternalMetricDefinitionContractDtoWarehouseNativeNumeratorAggregationEnum = typeof ExternalMetricDefinitionContractDtoWarehouseNativeNumeratorAggregationEnum[keyof typeof ExternalMetricDefinitionContractDtoWarehouseNativeNumeratorAggregationEnum];
