...
**data** | [**Array&lt;KeyDto&gt;**](KeyDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1KeysGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1KeysGet200Response = {
    message,
    data,
    pagination,
};
