...
**data** | [**Array&lt;ParamStoreDto&gt;**](ParamStoreDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1ParamStoresGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ParamStoresGet200Response = {
    message,
    data,
    pagination,
};
