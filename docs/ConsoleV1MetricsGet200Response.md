...
**data** | [**Array&lt;MetricValuesDto&gt;**](MetricValuesDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1MetricsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1MetricsGet200Response = {
    message,
    data,
    pagination,
};
