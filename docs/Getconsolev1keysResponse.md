...
**data** | [**Array&lt;KeyDto&gt;**](KeyDto.md) | Array of KeyDto items. | [default to undefined]
**pagination** | [**PaginationResponseMetadataDto**](PaginationResponseMetadataDto.md) |  | [default to undefined]

## Example

```typescript
import { Getconsolev1keysResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1keysResponse = {
    message,
    data,
    pagination,
};
