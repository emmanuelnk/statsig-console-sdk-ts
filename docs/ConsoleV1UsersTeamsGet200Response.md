...
**data** | [**Array&lt;TeamDtoWithoutMembersDto&gt;**](TeamDtoWithoutMembersDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1UsersTeamsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1UsersTeamsGet200Response = {
    message,
    data,
    pagination,
};
