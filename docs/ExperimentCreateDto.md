...
------------ | ------------- | ------------- | -------------
**name** | **string** | The experiment display name | [default to undefined]
**description** | **string** | A description of the new experiment | [optional] [default to undefined]
**idType** | **string** | The idType the experiment will be performed on | [optional] [default to undefined]
...
**id** | **string** | The experiment name ID | [optional] [default to undefined]
**layerID** | **string** | Which layer to place the experiment into. | [optional] [default to undefined]
