...
**data** | [**Array&lt;AutotuneExperimentDto&gt;**](AutotuneExperimentDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1AutotunesGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1AutotunesGet200Response = {
    message,
    data,
    pagination,
};
