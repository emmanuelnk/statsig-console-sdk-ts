...
**data** | [**Array&lt;GateRulesDto&gt;**](GateRulesDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1GatesIdRulesGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1GatesIdRulesGet200Response = {
    message,
    data,
    pagination,
};
