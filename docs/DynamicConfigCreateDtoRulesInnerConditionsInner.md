# DynamicConfigCreateDtoRulesInnerConditionsInner
...
```typescript
import { DynamicConfigCreateDtoRulesInnerConditionsInner } from 'statsig-console-sdk-nodejs';

const instance: DynamicConfigCreateDtoRulesInnerConditionsInner = {
    targetValue,
    operator,
    field,
    customID,
