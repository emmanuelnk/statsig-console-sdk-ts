...
**status** | **string** | Current evaluation status of the alert | [default to undefined]
**lastTriggeredTime** | **number** | Timestamp in milliseconds of the last time this alert triggered | [default to undefined]

## Example

```typescript
import { AlertDetailsSchemaDto } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: AlertDetailsSchemaDto = {
    id,
    name,
    alertType,
    metrics,
