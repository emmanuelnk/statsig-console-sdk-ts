...
export interface ExperimentFullUpdateDto {
     ...
     */
    'sprtBaselineMode'?: ExperimentFullUpdateDtoSprtBaselineModeEnum;
    /**
...
export const ExperimentFullUpdateDtoSprtBaselineModeEnum = {
    Manual: 'manual',
    InExperimentControl: 'in_experiment_control'
} as const;

export type ExperimentFullUpdateDtoSprtBaselineModeEnum = typeof ExperimentFullUpdateDtoSprtBaselineModeEnum[keyof typeof ExperimentFullUpdateDtoSprtBaselineModeEnum];
