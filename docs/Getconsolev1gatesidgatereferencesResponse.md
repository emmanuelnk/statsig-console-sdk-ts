...
Response for getconsolev1gatesidgatereferences
...
```typescript
import { Getconsolev1gatesidgatereferencesResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1gatesidgatereferencesResponse = {
    message,
    data,
    pagination,
};
