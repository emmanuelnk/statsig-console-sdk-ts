...
export interface TeamCreationDto {
     ...
     */
    'changeTeamConfigs': TeamCreationDtoChangeTeamConfigsEnum;
    /**
     * Who can review and approve changes: \"anyone\", \"team_only\", or \"admin_only\".
     */
    'reviewApproval': TeamCreationDtoReviewApprovalEnum;
    /**
...
export const TeamCreationDtoChangeTeamConfigsEnum = {
    Anyone: 'anyone',
    TeamOnly: 'team_only'
} as const;

export type TeamCreationDtoChangeTeamConfigsEnum = typeof TeamCreationDtoChangeTeamConfigsEnum[keyof typeof TeamCreationDtoChangeTeamConfigsEnum];
export const TeamCreationDtoReviewApprovalEnum = {
    Anyone: 'anyone',
    TeamOnly: 'team_only',
    AdminOnly: 'admin_only'
} as const;

export type TeamCreationDtoReviewApprovalEnum = typeof TeamCreationDtoReviewApprovalEnum[keyof typeof TeamCreationDtoReviewApprovalEnum];
