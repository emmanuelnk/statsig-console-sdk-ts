...
**data** | [**Array&lt;PulseLoadHistoryDto&gt;**](PulseLoadHistoryDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1ExperimentsIdPulseLoadHistoryGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ExperimentsIdPulseLoadHistoryGet200Response = {
    message,
    data,
    pagination,
};
