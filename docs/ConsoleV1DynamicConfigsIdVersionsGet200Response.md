...
**data** | [**Array&lt;DynamicConfigDto&gt;**](DynamicConfigDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1DynamicConfigsIdVersionsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1DynamicConfigsIdVersionsGet200Response = {
    message,
    data,
    pagination,
};
