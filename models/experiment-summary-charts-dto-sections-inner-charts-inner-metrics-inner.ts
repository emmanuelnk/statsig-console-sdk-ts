...
// May contain unused imports in some cases
// @ts-ignore
import type { ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner } from './experiment-summary-charts-dto-sections-inner-charts-inner-metrics-inner-dimension-breakdown-inner';

export interface ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInner {
    'metricID': string;
    'metricName': string;
    /**
     ...
     */
    'directionality': ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDirectionalityEnum;
    ...
    'dimensionBreakdown'?: Array<ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDimensionBreakdownInner>;
}

export const ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDirectionalityEnum = {
    Increase: 'increase',
    Decrease: 'decrease'
} as const;

export type ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDirectionalityEnum = typeof ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDirectionalityEnum[keyof typeof ExperimentSummaryChartsDtoSectionsInnerChartsInnerMetricsInnerDirectionalityEnum];
