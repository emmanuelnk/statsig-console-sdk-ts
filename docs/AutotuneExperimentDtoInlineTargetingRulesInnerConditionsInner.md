# AutotuneExperimentDtoInlineTargetingRulesInnerConditionsInner
...
```typescript
import { AutotuneExperimentDtoInlineTargetingRulesInnerConditionsInner } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: AutotuneExperimentDtoInlineTargetingRulesInnerConditionsInner = {
    targetValue,
    operator,
    field,
    customID,
