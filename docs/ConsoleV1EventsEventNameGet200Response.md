...
**data** | [**Array&lt;LoggedEventDto&gt;**](LoggedEventDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1EventsEventNameGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1EventsEventNameGet200Response = {
    message,
    data,
    pagination,
};
