...
------------ | ------------- | ------------- | -------------
**name** | **string** | Optional new name for the entity property source. | [optional] [default to undefined]
**description** | **string** | Optional updated context for the entity property source. | [optional] [default to undefined]
