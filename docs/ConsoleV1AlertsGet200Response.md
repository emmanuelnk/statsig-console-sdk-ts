...
**data** | [**Array&lt;AlertSchemaDto&gt;**](AlertSchemaDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1AlertsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1AlertsGet200Response = {
    message,
    data,
    pagination,
};
