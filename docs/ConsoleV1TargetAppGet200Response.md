...
**data** | [**Array&lt;TargetAppDto&gt;**](TargetAppDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1TargetAppGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1TargetAppGet200Response = {
    message,
    data,
    pagination,
};
