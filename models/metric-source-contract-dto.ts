...
export interface MetricSourceContractDto {
     ...
     */
    'sourceType'?: MetricSourceContractDtoSourceTypeEnum;
    /**
...
export const MetricSourceContractDtoSourceTypeEnum = {
    Table: 'table',
    Query: 'query'
} as const;

export type MetricSourceContractDtoSourceTypeEnum = typeof MetricSourceContractDtoSourceTypeEnum[keyof typeof MetricSourceContractDtoSourceTypeEnum];
