...
export interface ExternalExperimentDto {
     ...
     */
    'identifierMappingMode'?: ExternalExperimentDtoIdentifierMappingModeEnum;
    /**
     ...
     */
    'status': ExternalExperimentDtoStatusEnum;
    /**
     ...
     */
    'scheduledReloadType'?: ExternalExperimentDtoScheduledReloadTypeEnum;
    /**
     ...
     */
    'healthCheckStatus': ExternalExperimentDtoHealthCheckStatusEnum;
    /**
...
export const ExternalExperimentDtoIdentifierMappingModeEnum = {
    StrictOneToOne: 'strictOneToOne',
    FirstTouchOneToMany: 'firstTouchOneToMany',
    LastTouchOneToMany: 'lastTouchOneToMany'
} as const;

export type ExternalExperimentDtoIdentifierMappingModeEnum = typeof ExternalExperimentDtoIdentifierMappingModeEnum[keyof typeof ExternalExperimentDtoIdentifierMappingModeEnum];
export const ExternalExperimentDtoDefaultConfidenceIntervalEnum = {
    _80: '80',
    _90: '90',
    _95: '95',
    _98: '98',
...
export type ExternalExperimentDtoDefaultConfidenceIntervalEnum = typeof ExternalExperimentDtoDefaultConfidenceIntervalEnum[keyof typeof ExternalExperimentDtoDefaultConfidenceIntervalEnum];
export const ExternalExperimentDtoStatusEnum = {
    Active: 'active',
    Setup: 'setup',
...
export type ExternalExperimentDtoStatusEnum = typeof ExternalExperimentDtoStatusEnum[keyof typeof ExternalExperimentDtoStatusEnum];
export const ExternalExperimentDtoScheduledReloadTypeEnum = {
    Full: 'full',
...
export type ExternalExperimentDtoSubtypeEnum = typeof ExternalExperimentDtoSubtypeEnum[keyof typeof ExternalExperimentDtoSubtypeEnum];
export const ExternalExperimentDtoHealthCheckStatusEnum = {
    Passed: 'PASSED',
    Failed: 'FAILED',
    Waiting: 'WAITING',
    Warning: 'WARNING'
...
export const ExternalExperimentDtoExperimentTypeEnum = {
    Base: 'BASE',
    Geo: 'GEO',
...
export type ExternalExperimentDtoExperimentTypeEnum = typeof ExternalExperimentDtoExperimentTypeEnum[keyof typeof ExternalExperimentDtoExperimentTypeEnum];
