...
Response for getconsolev1metricsmetricsourcenamemetrics
...
```typescript
import { Getconsolev1metricsmetricsourcenamemetricsResponse } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: Getconsolev1metricsmetricsourcenamemetricsResponse = {
    message,
    data,
    pagination,
};
