...
**description** | **string** | A detailed description of the source, providing context and usage information. | [default to undefined]
**tags** | **Array&lt;string&gt;** | Optional tags for categorizing the source and improving searchability. | [optional] [default to undefined]
...
```typescript
import { MetricSourceContractDto } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: MetricSourceContractDto = {
    name,
    description,
    tags,
    sql,
