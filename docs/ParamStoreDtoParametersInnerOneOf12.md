# ParamStoreDtoParametersInnerOneOf12
...
```typescript
import { ParamStoreDtoParametersInnerOneOf12 } from 'statsig-console-sdk-nodejs';

const instance: ParamStoreDtoParametersInnerOneOf12 = {
    ref_type,
    name,
    param_type,
    experiment_name,
