...
**data** | [**Array&lt;ExternalExperimentDto&gt;**](ExternalExperimentDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1ExperimentsIdVersionsGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ExperimentsIdVersionsGet200Response = {
    message,
    data,
    pagination,
};
