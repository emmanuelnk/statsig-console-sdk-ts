...
**conditions** | [**Array&lt;SegmentCreateContractDtoRulesInnerConditionsInner&gt;**](SegmentCreateContractDtoRulesInnerConditionsInner.md) |  | [default to undefined]
...
```typescript
import { SegmentCreateContractDtoRulesInner } from '@emmanuelnk/statsig-console-sdk-ts';

const instance: SegmentCreateContractDtoRulesInner = {
    name,
    passPercentage,
    conditions,
    environments,
