...
export interface ExperimentCreateDto {
     ...
     */
    'identifierMappingMode'?: ExperimentCreateDtoIdentifierMappingModeEnum;
    /**
     ...
     */
    'defaultConfidenceInterval'?: ExperimentCreateDtoDefaultConfidenceIntervalEnum;
    /**
     ...
     */
    'status'?: ExperimentCreateDtoStatusEnum;
    /**
     ...
     */
    'scheduledReloadType'?: ExperimentCreateDtoScheduledReloadTypeEnum;
    /**
     ...
     */
    'analyticsType'?: ExperimentCreateDtoAnalyticsTypeEnum;
    /**
     ...
     */
    'sprtBaselineMode'?: ExperimentCreateDtoSprtBaselineModeEnum;
    /**
...
export const ExperimentCreateDtoIdentifierMappingModeEnum = {
    StrictOneToOne: 'strictOneToOne',
    FirstTouchOneToMany: 'firstTouchOneToMany',
    LastTouchOneToMany: 'lastTouchOneToMany'
} as const;

export type ExperimentCreateDtoIdentifierMappingModeEnum = typeof ExperimentCreateDtoIdentifierMappingModeEnum[keyof typeof ExperimentCreateDtoIdentifierMappingModeEnum];
export const ExperimentCreateDtoDefaultConfidenceIntervalEnum = {
    _80: '80',
    _90: '90',
    _95: '95',
    _98: '98',
...
export type ExperimentCreateDtoDefaultConfidenceIntervalEnum = typeof ExperimentCreateDtoDefaultConfidenceIntervalEnum[keyof typeof ExperimentCreateDtoDefaultConfidenceIntervalEnum];
export const ExperimentCreateDtoStatusEnum = {
    Active: 'active',
    Setup: 'setup',
...
export type ExperimentCreateDtoStatusEnum = typeof ExperimentCreateDtoStatusEnum[keyof typeof ExperimentCreateDtoStatusEnum];
export const ExperimentCreateDtoScheduledReloadTypeEnum = {
    Full: 'full',
    Incremental: 'incremental'
} as const;

export type ExperimentCreateDtoScheduledReloadTypeEnum = typeof ExperimentCreateDtoScheduledReloadTypeEnum[keyof typeof ExperimentCreateDtoScheduledReloadTypeEnum];
export const ExperimentCreateDtoAnalyticsTypeEnum = {
    Frequentist: 'frequentist',
    Bayesian: 'bayesian',
    Sprt: 'sprt'
} as const;

export type ExperimentCreateDtoAnalyticsTypeEnum = typeof ExperimentCreateDtoAnalyticsTypeEnum[keyof typeof ExperimentCreateDtoAnalyticsTypeEnum];
export const ExperimentCreateDtoSprtBaselineModeEnum = {
    Manual: 'manual',
    InExperimentControl: 'in_experiment_control'
} as const;

export type ExperimentCreateDtoSprtBaselineModeEnum = typeof ExperimentCreateDtoSprtBaselineModeEnum[keyof typeof ExperimentCreateDtoSprtBaselineModeEnum];
