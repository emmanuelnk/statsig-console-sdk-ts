...
**data** | [**Array&lt;AssignmentSourceContractDto&gt;**](AssignmentSourceContractDto.md) |  | [default to undefined]
...
```typescript
import { ConsoleV1ExperimentsAssignmentSourcesGet200Response } from 'statsig-console-sdk-nodejs';

const instance: ConsoleV1ExperimentsAssignmentSourcesGet200Response = {
    message,
    data,
    pagination,
};
